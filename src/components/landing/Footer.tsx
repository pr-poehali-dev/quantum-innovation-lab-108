      ...
      <div className="flex flex-col items-center text-center">
        <a href="#" className="flex items-center justify-center mb-4">
          <span className="text-2xl font-bold text-black dark:text-white">
            Екатерина<span className="text-[#7A7FEE]"> Великая</span>
          </span>
        </a>
        <p className="text-sm text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-8">
          Дипломированный цифровой психолог. Помогаю найти свой путь, реализоваться и жить в гармонии с собой.
        </p>

        <p className="text-sm text-gray-500 dark:text-gray-400">
          {new Date().getFullYear()} Екатерина Великая. Все права защищены.
        </p>
      </div>
    </footer>
  )
